...
export default function Contact() {
  ...
  return (
    <div id="contact" className="bg-slate-900">
      ...
      <div className="mt-10 max-w-3xl text-white mx-auto">
        <div className="text-center font-title text-3xl mb-4 md:flex gap-4">
          ...
          <TypeAnimation
            ...
            className="text-blue-300 static font-title"
          />
        </div>
            ...
            <div className="grid gap-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-md border active:outline-none focus:outline-none focus:border-slate-900 border-slate-900  bg-slate-800"
              ...
              <div className="my-4 relative">
                <textarea
                  id="message"
                  name="message"
                  className="h-[50vh] border text-sm w-full rounded focus:border-slate-900 border-slate-900  bg-slate-800"
                ...
                <div className="absolute bottom-0 right-0 -translate-x-1/4 -translate-y-1/4">
                  ...
                  >
                    ...
                    <BsSend
                      className={`${formState.sending ? "hidden" : ""} text-xs`}
                    />
                  </button>
                </div>
              </div>
