...
export default function IDE({codeSVG}) {
  ...
  return (
    <Waypoint onEnter={() => setIsInvisible(true)} onLeave={() => setIsInvisible(false)} bottomOffset={"85%"}>
      <div className="shadow border-8   border-black flex flex-col bg-[#263238] overflow-hidden  rounded-3xl  text-white w-full">
        <div className="flex flex-1">
          <div className="flex font-monospace text-xs md:text-sm leading-6 overflow-auto max-w-screen h-screen ">
