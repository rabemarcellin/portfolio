      ...
      <div className="md:flex md:gap-8">
        ...
        <div className="break-words ">
          <div className="site-details md:grid gap-4 leading-6 md:leading-10">
            <div>
              <div className="mt-8 mb-2 font-bold text-lg md:text-2xl">{t("contact")}</div>
            ...
            <div>
              <div className="font-bold text-lg md:text-2xl mt-8 mb-2">{t("social-networks")}</div>
              <ul className="">
                <li className="footer__card__social footer__card__social--linkedin">
                  ...
                  >
                    <ShowIcon name='fa-linkedin' className="icon icon--linkedin" />
                ...
                <li className="footer__card__social footer__card__social--facebook">
                  <a
                    ...
                    className="transition duration-300 flex gap-4 items-center"
                  >
                    <ShowIcon name='fa-facebook' className="icon icon--facebook" />
                    <div className="leading-normal">
                      <div className="h-fit">RABE Marcellin</div>
                      <div className="social__name">
                        Facebook
