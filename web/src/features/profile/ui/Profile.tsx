...
export default function Profile() {
  ...
  return (
    <Linked id="profile" className="dark:bg-neutral-950">
      <div className="max-w-5xl mx-auto px-4">
        <div className="grid md:grid-cols-2">
          <div className="order-first flex justify-center items-center p-4">
            <div className="profile__image__cadre bg-white dark:bg-neutral-950">
              <img src={ProfileImg} alt="" className="w-full h-full rounded-3xl" />
          ...
          <div className="order-last md:order-first">
            <h6 className="profile__introduce text-center justify-center md:text-start mt-8 md:mt-0">
              ...
              <div className="text-lg mt-3 md:text-xl text-gray-500 dark:text-gray-6500">
              ...
              <TypeAnimation
                ...
                speed={20}
                repeat={Infinity}
                className="text-start md:text-5xl text-3xl font-medium! text-title inline-block"
              />
